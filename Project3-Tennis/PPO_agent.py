...
class UnityTask:
    def __init__(self,  name):
        ...
        print("action dim",self.action_dim,"observation spsace",self.observation_space)
    ...
    def create_unity_env(self):
        env = UnityEnvironment(file_name="/home/paypaytr/Desktop/MLAgentBanana/tenis/Tennis.x86_64")
