...
This project implement a Value Based method called [Rainbow Deep Q-Network](https://deepmind.com/research/dqn/)
...
More on topic can be found here https://deepmind.com/research/publications/rainbow-combining-improvements-deep-reinforcement-learning


### My Setup

I have trained this agent on my local native Linux Ubuntu 18.04 LTS machine running with NVIDIA Cuda supported GPU with 2GB VRAM
Model file is (.pth , pyTorch related) only suitable with CUDA enabled GPUs.
